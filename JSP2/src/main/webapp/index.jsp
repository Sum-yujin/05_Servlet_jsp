...
<body>
  <pre>
    브라우저 주소창에 
    서버 컴퓨터 주소(ip:port,  ex) localhost:80만 작성하면
  ...
  <pre>
    - 클라이언트 요청을 받은 Servlet/JSP가 직접 응답하는 것이 아닌
      다른 Servlet/JSP에 HttpServletRquest, HttpServletResponse 객체를 
      넘겨서(위임) 대신 응답하게 하는 것
  ...
  <pre>
    ...
    = 보통 Servlet 요청 처리 후 특정 JSP로 요청을 위임해
      ...
      다른 Servlet을 다시 요청하여 다른 
      Servlet의 결과 화면을 응답해줌
    ...
    - redirect는 응답 화면의 주소가 처음 요청한 Servlet 주소가 
      아닌 다시 요청한 Servlet 주소로 변경된다!

    - 다른 Servlet을 요청하기 위해서는 "요청 주소"를 
      다시 작성해야 한다
