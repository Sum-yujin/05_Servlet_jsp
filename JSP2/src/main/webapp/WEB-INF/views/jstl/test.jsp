...
<body>
  ...
  <pre>
    [c:choose 태그]
      ...
      * 주의 사항 *
        바로 한 단계 아래에는 c:when, c:otherwise, jsp 주석만 작성할 수 있고
        나머진 모두 에러 발생!!
  ...
  <p><mark>1~6까지 1씩 증가하는 for문</mark></p>
  ...
  <p><mark>6~1까지 1씩 감소하는 for문</mark></p>
  <%-- step 속성 값은 양수만 가능!!! --%>
  <c:forEach var="i" begin="1" end="6" step="1">
  ...
  <%-- varStatus : 현재 반복 상태와 관련된 정보를 제공하는 변수 --%>
  <ul>
    <c:forEach var="name" 
               items="${nameList}"
               varStatus="vs">
